...
| [Real-time System](./v3/architecture/14-real-time.md) | **NEW** — WebSocket Gateway DO | Channels, presence, SSE fallback, client SDK |
| [Analytics & Insights](./v3/architecture/15-analytics.md) | **NEW** — Analytics Engine pipeline | Event ingestion, dashboards, CSV/JSON export |
| [Sponsor Portal](./v3/architecture/16-sponsor-portal.md) | **NEW** — Sponsor management | Tiers, R2 assets, branded pages, lead capture, ROI |
| [Mentorship System](./v3/architecture/17-mentorship.md) | **NEW** — Mentor-team matching | Session DO, scheduling, messaging, feedback |
| [Multi-org Federation](./v3/architecture/18-federation.md) | **NEW** — Cross-org discovery | DNS verification, trust levels, shared profiles |
| [Plugin Extensibility](./v3/architecture/19-plugin-system.md) | **NEW** — Lifecycle hooks | Webhook dispatch, plugin manifest, marketplace |
