...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'auth/callback/:provider', element: <CallbackPage /> },
      { path: 'hackathons', element: <BrowsePage /> },
      { path: 'hackathons/:slug', element: <HackathonDetailPage /> },
      { path: 'profile', element: <ProtectedRoute><ProfilePage /></ProtectedRoute> },
      { path: 'invite/:token', element: <ProtectedRoute><AcceptInvitePage /></ProtectedRoute> },
    ],
  },
]);
