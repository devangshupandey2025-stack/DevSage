...
- Use GitHub App installation tokens for 5,000 req/hr (vs 60 unauthenticated)
- Cache repo validation results in KV for 5 minutes to avoid redundant checks
- Handle 403/429 responses with a specific error code:
...
CREATE TABLE team_repos (
  ...
  bot_active INTEGER NOT NULL DEFAULT 0,     -- SQLite boolean (0=false, 1=true)
