-- v3 Clean Reset Migration
-- Drops ALL v2 tables and recreates from current Drizzle schema
...
-- ============================================================
-- PHASE 3: CREATE all v3 tables (parent-first order)
-- ============================================================
...
--> statement-breakpoint
CREATE UNIQUE INDEX `pending_installations_provider_repo_idx` ON `pending_installations` (`provider`,`repo_full_name`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `notification_idempotency_idempotency_key_unique` ON `notification_idempotency` (`idempotency_key`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `notification_deliveries_event_user_channel_idx` ON `notification_deliveries` (`event_id`,`user_id`,`channel`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `workspace_invites_code_unique` ON `workspace_invites` (`code`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `hackathon_templates_ws_idx` ON `hackathon_templates` (`workspace_id`);--> statement-breakpoint
CREATE INDEX `hackathon_templates_creator_idx` ON `hackathon_templates` (`created_by`);--> statement-breakpoint
...
CREATE INDEX `idx_hackathons_workspace` ON `hackathons` (`workspace_id`);--> statement-breakpoint
CREATE INDEX `idx_hackathons_status` ON `hackathons` (`status`);--> statement-breakpoint
CREATE INDEX `idx_hackathons_created_by` ON `hackathons` (`created_by`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `hackathon_sponsors_hackathon_tier_idx` ON `hackathon_sponsors` (`hackathon_id`,`tier`,`sort_order`);--> statement-breakpoint
CREATE UNIQUE INDEX `hackathon_sponsors_name_idx` ON `hackathon_sponsors` (`hackathon_id`,`name`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `hackathon_rounds_number_idx` ON `hackathon_rounds` (`hackathon_id`,`round_number`);--> statement-breakpoint
CREATE INDEX `hackathon_rounds_status_idx` ON `hackathon_rounds` (`hackathon_id`,`status`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `hackathon_notification_config_hackathon_id_unique` ON `hackathon_notification_config` (`hackathon_id`);--> statement-breakpoint
...
CREATE INDEX `idx_teams_invite_code` ON `teams` (`invite_code`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `in_app_notifications_user_read_idx` ON `in_app_notifications` (`user_id`,`read`,`created_at`);--> statement-breakpoint
CREATE INDEX `in_app_notifications_user_hackathon_idx` ON `in_app_notifications` (`user_id`,`hackathon_id`);--> statement-breakpoint
CREATE INDEX `in_app_notifications_created_idx` ON `in_app_notifications` (`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_audit_hackathon_time` ON `audit_events` (`hackathon_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `idx_audit_hackathon_seq` ON `audit_events` (`hackathon_id`,`sequence`);--> statement-breakpoint
CREATE INDEX `idx_audit_entity` ON `audit_events` (`entity_type`,`entity_id`);--> statement-breakpoint
CREATE INDEX `idx_audit_actor` ON `audit_events` (`actor_id`,`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `team_repos_hackathon_repo_idx` ON `team_repos` (`hackathon_id`,`repo_full_name`);--> statement-breakpoint
CREATE INDEX `team_repos_team_idx` ON `team_repos` (`team_id`);--> statement-breakpoint
CREATE INDEX `team_repos_repo_idx` ON `team_repos` (`repo_full_name`);--> statement-breakpoint
CREATE INDEX `team_repos_bot_idx` ON `team_repos` (`hackathon_id`,`bot_active`);--> statement-breakpoint
...
CREATE INDEX `webhook_deliveries_hackathon_idx` ON `webhook_deliveries` (`hackathon_id`,`received_at`);--> statement-breakpoint
CREATE INDEX `webhook_deliveries_status_idx` ON `webhook_deliveries` (`status`);--> statement-breakpoint
CREATE INDEX `webhook_deliveries_repo_idx` ON `webhook_deliveries` (`repo_full_name`);--> statement-breakpoint
...
CREATE INDEX `idx_judges_user` ON `judges` (`user_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `rubric_criteria_hackathon_id_name_track_id_round_unique` ON `rubric_criteria` (`hackathon_id`,`name`,`track_id`,`round`);--> statement-breakpoint
CREATE INDEX `idx_rubric_round` ON `rubric_criteria` (`hackathon_id`,`round`);--> statement-breakpoint
...
CREATE INDEX `idx_submissions_hackathon_status` ON `submissions` (`hackathon_id`,`status`);--> statement-breakpoint
CREATE INDEX `idx_submissions_team` ON `submissions` (`team_id`);--> statement-breakpoint
CREATE INDEX `idx_submissions_hackathon_final` ON `submissions` (`hackathon_id`,`is_final`);--> statement-breakpoint
CREATE INDEX `idx_submissions_round_team` ON `submissions` (`round_id`,`team_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_commit_log_team_time` ON `commit_log` (`hackathon_id`,`team_id`,`committed_at`);--> statement-breakpoint
CREATE INDEX `idx_commit_log_sha` ON `commit_log` (`sha`);--> statement-breakpoint
CREATE INDEX `idx_commit_log_delivery` ON `commit_log` (`delivery_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_force_push_hackathon_time` ON `force_push_events` (`hackathon_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `idx_force_push_team` ON `force_push_events` (`team_id`);--> statement-breakpoint
CREATE INDEX `idx_force_push_resolved` ON `force_push_events` (`resolved`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `judge_assignments_judge_id_team_id_round_unique` ON `judge_assignments` (`judge_id`,`team_id`,`round`);--> statement-breakpoint
CREATE INDEX `idx_judge_assignments_hackathon_round` ON `judge_assignments` (`hackathon_id`,`round`,`status`);--> statement-breakpoint
CREATE INDEX `idx_judge_assignments_judge` ON `judge_assignments` (`judge_id`,`status`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `scores_submission_id_judge_id_criteria_id_round_unique` ON `scores` (`submission_id`,`judge_id`,`criteria_id`,`round`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_ai_reviews_submission` ON `ai_reviews` (`submission_id`);--> statement-breakpoint
CREATE INDEX `idx_ai_reviews_commit_sha` ON `ai_reviews` (`commit_sha`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `round_results_round_team_idx` ON `round_results` (`round_id`,`team_id`);--> statement-breakpoint
CREATE INDEX `round_results_hackathon_status_idx` ON `round_results` (`hackathon_id`,`status`);--> statement-breakpoint
CREATE INDEX `round_results_team_idx` ON `round_results` (`team_id`);--> statement-breakpoint

-- ============================================================
-- PHASE 4: Seed data for hack001
-- ============================================================

-- a. System user
INSERT OR IGNORE INTO `users` (`id`, `github_id`, `google_id`, `github_username`, `display_name`, `email`, `avatar_url`, `email_verified`, `email_bounced`, `suspended`, `suspended_at`, `suspended_reason`, `last_login_at`, `created_at`, `updated_at`)
VALUES ('00000000-0000-0000-0000-000000000001', 1, NULL, 'devseed', 'Dev Seed', NULL, NULL, 0, 0, 0, NULL, NULL, NULL, '2026-02-15T00:00:00.000Z', '2026-02-15T00:00:00.000Z');
--> statement-breakpoint

-- b. Workspace
INSERT OR IGNORE INTO `workspaces` (`id`, `name`, `slug`, `description`, `logo_url`, `website`, `settings`, `created_by`, `created_at`, `updated_at`)
VALUES ('ws-000', 'DevSage', 'devsage', '', NULL, NULL, '{}', '00000000-0000-0000-0000-000000000001', '2026-02-15T00:00:00.000Z', '2026-02-15T00:00:00.000Z');
--> statement-breakpoint
...
VALUES ('11111111-1111-1111-1111-111111111111', 'ws-000', 'hack001', 'hack001', NULL, NULL, NULL, 'active', NULL, NULL, NULL, 1, 5, NULL, 'submission_v%', 0, 0, 0, 0, 'open', '[]', 1, 'UTC', NULL, '[]', '[]', '{}', '00000000-0000-0000-0000-000000000001', '2026-02-15T00:00:00.000Z', '2026-02-15T00:00:00.000Z');
--> statement-breakpoint

-- d. Hackathon round for hack001
...
VALUES ('round-001', '11111111-1111-1111-1111-111111111111', 1, 'Round 1', 'standard', 'active', NULL, NULL, NULL, '2026-02-15T00:00:00.000Z', '2026-02-15T00:00:00.000Z');
--> statement-breakpoint

-- e. Organizer role linking seed user as 'organizer' for hack001
INSERT OR IGNORE INTO `organizer_roles` (`id`, `hackathon_id`, `user_id`, `role`, `created_at`)
VALUES ('org-001', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', 'organizer', '2026-02-15T00:00:00.000Z');
--> statement-breakpoint

-- f. Workspace member linking seed user to workspace as 'owner'
INSERT OR IGNORE INTO `workspace_members` (`id`, `workspace_id`, `user_id`, `role`, `invited_by`, `created_at`, `updated_at`)
VALUES ('wm-001', 'ws-000', '00000000-0000-0000-0000-000000000001', 'workspace_owner', NULL, '2026-02-15T00:00:00.000Z', '2026-02-15T00:00:00.000Z');
