...
import { ArrowLeft, Sparkles, Shield, Github, Loader2 } from 'lucide-react';
...
function LoginPage() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl flex-col-reverse items-center gap-16 px-6 py-16 lg:flex-row lg:items-stretch lg:py-24">
        {/* Left — Branding */}
        <motion.section
        ...
        >
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg text-white/60">
              Your dashboard, teams, and live hackathons live here. Sign in to keep shipping.
            </p>
          </div>
          ...
          <Card className="w-full border-white/10 bg-black/60 backdrop-blur-xl">
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                disabled={signingIn !== null}
                className="w-full border-white/20 bg-transparent text-white hover:bg-white/5 disabled:opacity-50"
              >
                {signingIn === 'google' ? (
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                ) : (
              ...
              <p className="pt-2 text-center text-xs text-white/40">
                ...
                <Link to="/" className="text-[#CCFF00]/70 hover:underline">
