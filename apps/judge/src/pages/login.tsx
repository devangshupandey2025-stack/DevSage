...
import { ArrowLeft, Gavel, Shield, Loader2, Mail, Lock } from 'lucide-react';
        ...
        >
          <div>
            <button
              ...
              onClick={() => window.location.href = 'https://devsage.org'}
            >
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs uppercase tracking-[0.3em] text-white/60">
              <Gavel className="h-4 w-4 text-[#CCFF00]" />
              Judge Portal
            </div>
            <h1 className="mt-8 text-4xl font-black leading-tight text-white md:text-5xl lg:text-6xl">
              Score submissions with confidence.
            </h1>
            <p className="mt-6 max-w-xl text-lg text-white/60">
              Review team submissions, score against rubric criteria, and help determine the winners of world-class hackathons.
            </p>
          </div>

          <div className="mt-12 grid gap-6 sm:grid-cols-2">
            {[
              { label: 'Rubric-Based', value: 'Scoring' },
              { label: 'Fair & Transparent', value: 'Judging' },
            ].map((stat) => (
        ...
        >
          <Card className="border-white/10 bg-black/60 backdrop-blur-xl">
            <CardHeader className="space-y-4 text-center">
              ...
              <CardTitle className="text-3xl text-white">Judge Login</CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-center text-xs text-white/40">
                  By continuing you agree to the DevSage{' '}
                  <a onClick={() => window.open('https://devsage.org/terms', '_blank')} className="underline cursor-pointer">Terms of Service</a>{' '}
                  and <a onClick={() => window.open('https://devsage.org/privacy', '_blank')} className="underline cursor-pointer">Privacy Policy</a>.
                </p>
              </form>
            </CardContent>
          </Card>
